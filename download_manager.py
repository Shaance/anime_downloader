...
def download_show(mode: str, url: str, res: int, output_directory: str, show_name: str) -> (bool, str):
    ...
    if valid_mode and valid_res and valid_output_path:
        ...
        if links:
            ...
            return True, "Launched downloads in qbittorrent for {} at {}p".format(show_name, res)
        ...
        if not valid_mode:
            ...
            error_msg = "{} does not exist or you do not have the write permission for this directory." \
